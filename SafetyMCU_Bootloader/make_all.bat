...
rem please change the path name to your bootloader project folder
rem
...
rem cd C:\users\a0324020\workspace_v6_1\SafetyMCU_Bootloader\
rem cmd
...
call c:\ti\ccsv6\utils\bin\gmake -k all
cd ..
cd ..
cd ..
